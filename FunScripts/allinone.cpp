...
// items
#define token1 1000 // A token amit elcserél a játékos
#define token2 1000 // A token amit kap a játékos
#define vasarolhatotoken 1000 // Vásárolható token -.-
 ...
 
{
	...
	player->ADD_GOSSIP_ITEM(0, "[Menu]Sickness leszedése", GOSSIP_SENDER_MAIN, 120);
	player->ADD_GOSSIP_ITEM(0, "[Menu]Talent Pont Resetelése", GOSSIP_SENDER_MAIN, 121);
 ...
 
{
	...
	player->ADD_GOSSIP_ITEM(1, "Területek", GOSSIP_SENDER_MAIN, 604);
	break;
	...
	case 106: // Announcer Part
		...
		case 110: // VIP Functions, from another script(by me :D)
				player->ADD_GOSSIP_ITEM(0, "Javítás", GOSSIP_SENDER_MAIN, 1500);
				...
				player->ADD_GOSSIP_ITEM(0, "Faction váltás", GOSSIP_SENDER_MAIN, 1503);
				player->ADD_GOSSIP_ITEM(0, "Faj váltás", GOSSIP_SENDER_MAIN, 1504);
				//player->ADD_GOSSIP_ITEM(0, "Áthelyezés", GOSSIP_SENDER_MAIN, 1505); Not yet implemented
				player->ADD_GOSSIP_ITEM(0, "Név váltás", GOSSIP_SENDER_MAIN, 1506);
				player->ADD_GOSSIP_ITEM(0, "Karakter Mentés", GOSSIP_SENDER_MAIN, 1507);
...
break;
			...
			case 120: //Sickness leszedése
				...
				_Creature->CastSpell(player,38588,false); // Élet felnövelés
